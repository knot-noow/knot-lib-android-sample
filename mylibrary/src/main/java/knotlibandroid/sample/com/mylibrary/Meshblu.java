package knotlibandroid.sample.com.mylibrary;
...
public class Meshblu extends Emitter {
    ...
    /**
     * Set credention of meshblu cloud
     * @param meshbluConfig meshblu object.
     */
    ...
    public void register(SaneJSONObject properties) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, properties, new
    ...
    /**
     * Generate a token of a specific device
     * @param uuid
     */
    public void generateToken(String uuid) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, data, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
    ...
    public void whoami() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.i("DJACA", "WHOAMI: "+jsonObject.toString());
                emit(WHOAMI, jsonObject);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
    ...
    public void message(SaneJSONObject message) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, message, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.i("DJACA", "onResponse in message: " + jsonObject.toString());
                emit(MESSAGE);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Log.e("DJACA", "Error sending message", volleyError);
                emit(ERROR, volleyError);
            }
        }) {
            @Override
    ...
    public void updateDevice(String uuid, SaneJSONObject properties) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PATCH, url, properties, new
            Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject jsonObject) {
                    Log.i("DJACA", "onResponse in updateDevices: " + jsonObject.toString());
                    emit(UPDATE_DEVICE);
                }
            }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Log.e("DJACA", "Error updating device"+volleyError.toString(), volleyError);
                emit(ERROR, volleyError);
            }
        }) {
            @Override
    ...
    public void claimDevice(String uuid) {
        Log.d(TAG, "call claimDevice");
        RequestQueue queue = Volley.newRequestQueue(context);
        String url = String.format("%s/claimdevice/%s", MESHBLU_URL, uuid);

        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT, url, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.i("DJACA", "onResponse in claimDevice: " + jsonObject.toString());
                emit(CLAIM_DEVICE);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Log.e("DJACA", "Error updating device", volleyError);
                emit(ERROR, volleyError);
            }
        }) {
            @Override
    ...
    public void sendData(String uuid, SaneJSONObject message) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, message, new Response
            ...
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.i("DJACA", "onResponse in sendData: " + jsonObject.toString());
                emit(SEND_DATA);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Log.e("DJACA", "Error sending data", volleyError);
                emit(ERROR, volleyError);
            }
        }) {
            @Override
    ...
    public void deleteDevice(String uuid) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.DELETE, url, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                emit(DELETE_DEVICE);
    ...
    /**
     * Return a list of device connect on cloud
     *
     * @param options query option to select device.
     */
    public void devices(SaneJSONObject options) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, options, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.i("DJACA", "onResponse in devices: " + jsonObject.toString());
                emit(GET_DEVICE);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Log.e("DJACA", "Error getting devices", volleyError);
                emit(ERROR, volleyError);
            }
        }) {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
                Log.i("DJACA", "devices Headers toString: " + Meshblu.this.getHeaders());
                return Meshblu.this.getHeaders();
            }
        };
    ...
    public void getPublicKey(String uuid) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, new Response
            ...
            @Override
            public void onResponse(JSONObject jsonObject) {
                emit(GET_PUBLIC_KEY, jsonObject);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
    ...
    public void resetToken(String uuid) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                emit(RESET_TOKEN);
    ...
    public void updateDangerously(String uuid, SaneJSONObject properties) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT, url, properties, new Response
            .Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                emit(UPDATE_DEVICE, jsonObject);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
